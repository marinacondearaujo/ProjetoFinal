...
from langchain_core.prompts import ChatPromptTemplate, ChatPromptTemplate
...
os.environ["HUGGINGFACEHUB_API_TOKEN"] = "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"


#Configurações do Streamlit
st.set_page_config(page_title="Recupere informações específicas de domínio 📚", page_icon="📚")
st.title("Recupere informações específicas de domínio 📚")
